...
<style>
  ...
  .req-table {
    ...
    border-radius: var(--r-lg); overflow: hidden; box-shadow: 0 1px 3px rgb(20 24 27 / 8%);
  }
  .req-table th {
  ...
  .req-table td { padding: 0.5rem 0.8rem; border-bottom: 1px solid var(--line); font-size: var(--t-md); }
  .req-table tr:last-child td { border-bottom: none; }
  .metric { color: var(--mask); font-weight: 600; }
  .cat { font-size: var(--t-xs); color: var(--ink-soft); }
  .statement { color: var(--ink-soft); font-size: var(--t-sm); }
  .prov {
